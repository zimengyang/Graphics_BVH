...
public:
    ...
    glm::vec3 GetNormal(const glm::vec3 &P);//Returns the interpolation of the triangle's three normals
    ...
    void setBBox();
    QString getGeometryName() {return QString("Triangle");}
};
...
public:
    ...
    glm::vec2 GetUVCoordinates(const glm::vec3 &point) {return glm::vec2();} // blank Mesh GetUVCoordinates()
    void SetNormalMappingValue(Intersection &inter) {}
    void SamplingPointsOnSurface(const glm::vec3 hitPoint){}
    void setBBox();
    QString getGeometryName() {return QString("Mesh");}
